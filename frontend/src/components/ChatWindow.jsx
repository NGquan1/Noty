    ...
    <div className="fixed bottom-8 right-8 w-96 h-[500px] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl flex flex-col border border-gray-200 dark:border-gray-800 z-50 animate-slide-up">
      ...
      <div className="flex items-center justify-between p-4 bg-gray-100/80 dark:bg-gray-800 rounded-t-2xl border-b border-gray-200 dark:border-gray-700">
        ...
        <button
          ...
          className="p-1 rounded-full text-gray-500 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-violet-400"
        >
          <X size={20} />
        </button>
      </div>
            ...
            >
              {isOwn && (
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 transition-opacity p-1 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-red-400"
                >
                  <Trash2
                    size={15}
              ...
              >
                {!isOwn && (
                  <img
                    ...
                    className="w-8 h-8 rounded-full object-cover flex-shrink-0 border border-gray-300 dark:border-gray-700"
                  />
                )}
                <div
              ...
              {!isOwn && <div className="w-[31px] h-[31px] flex-shrink-0" />}
            </div>
          );
        })}
      </div>
